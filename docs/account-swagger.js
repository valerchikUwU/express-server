 ...
 *      tags:
 *          - Account
 *      summary: Запрос GET для получения формы обновления аккаунта для суперАдмина
 *      parameters:
 *        - in: path
 *          name: accountId
 *          required: true
 ...
 *      responses:
 *        200:
 *          description: Форма обновления аккаунта для суперАдмина
 *          content:
 *            application/json:
 *                      schema:
 *                          type: object
 ...
 *                              type: string
 *                              description: Форма обновления аккаунта для суперАдмина
 *                              example: "Форма обновления аккаунта для суперАдмина"
 *                            account:
 *                              type: object
 *                              description: Информация об аккаунте 
 *                              properties:
 ...
 *        tags:
 *            - Account
 *        summary: Запрос PUT для выбранного аккаунта для суперАдмина
 *        parameters:
 *          - in: path
 *            name: accountId
 *            required: true
